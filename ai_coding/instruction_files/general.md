...
- アプリケーションのレイヤーをalway-validレイヤーとそれ以外で分割
- always-validレイヤーでは検証済みのドメインモデルとそれを引数とする関数のみを扱う
...
1. **静的解析・型チェック**:
   <ここに静的解析や型チェックを行うコマンドを記入>

2. **コードフォーマッター**:
   <ここにコードフォーマッターを行うコマンドを記入>
